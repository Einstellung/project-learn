...
/// The output `(Bytes, Vec<U256>)` is not directly the 'calldata' in the Ethereum sense but rather
/// the components that need to be encoded into the calldata format -> 

    ...
    F: IsField,
{
    ...
    // let even_poly and odd_poly with same length. Doing this is easier for computing polynomial addition(just coefficients point addition)
    // but it is ok if we don't do this, polynomial addition alogrithm will take care of if the polynomials don't have same length

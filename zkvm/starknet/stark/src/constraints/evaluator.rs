...
impl<A: AIR> ConstraintEvaluator<A> {
        ...
        A: Send + Sync,
    {
        ...
        // zerofiers_inverse data like: [[(h-a_0)(hw-a_0)(hw^2-a0)...], [(h-a_1)(hw-a_1)(hw^2-a1)...], ...].inverse
        ...
        let evaluations_t = evaluations_t_iter
            ...
            .map(|(i, boundary)| {
                // Elements of the trace table are found in the `frame`
                // for example fibonacci transition_offsets: vec![0, 1, 2],

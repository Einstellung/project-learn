...
pub trait IsStarkProver<A: AIR> {
        ...
        A::Field: IsSubFieldOf<E>,
    {
        ...
        // Evaluate those polynomials t_j on the large domain D_LDE(low degree extension).
        ...
        // Compute commitment.
        // trace sequence as row permutate not column
        ...
        FieldElement<A::FieldExtension>: AsBytes + Sync + Send,
    {
        ...
        // lde_composition_poly_evaluations: [[H1(h), H2(h)], [H1(hw), H2(hw)]...]
        ...
        FieldElement<A::FieldExtension>: AsBytes + Send + Sync,
    {
        ...
        // in the fibonacci example, this evalutor.boundary_constraints actually is a[0] value
